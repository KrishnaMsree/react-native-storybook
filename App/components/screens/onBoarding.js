...
export default function OnBoarding({color}){
            ...
            <View style={{ flex: 1, marginTop: 10}}>
                ...
                >
                    <View style={styles.box}>
                        <Text style={[styles.boxHeader, {backgroundColor:color}]}>Employee Information</Text>
                    ...
                    <View style={styles.box}>
                        <Text style={[styles.boxHeader, {backgroundColor:color}]}>Tax Documents</Text>
                        <View style={styles.boxText} >
                            <View style={styles.boxTextView}>
