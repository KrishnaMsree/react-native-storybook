...
export default function Dashboard({HeadText, BtnText, onPress}){
        ...
        <View style={globalStyles.viewContainer}>
            ...
            <Card>
                <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                    <Text style={globalStyles.headerText} >{HeadText}</Text>
                </View>
                <PieChart onPress={onPress} style={{ height: 200 }} innerRadius={70} padAngle={0} spacing={0} data={pieData} />
                <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                ...
                <Button onPress={onPress} text={BtnText.text}/>
            </Card>
            <Card>
