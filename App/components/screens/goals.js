...
export default function Goals({label, onPress, color}){
  const data = [85,18  ]
 
  const randomColor = ['lightgrey',color]
    ...
    return (
      <ScrollView>
        <View style={globalStyles.viewContainer}>
            ...
            <Card label={label}>
              <MaterialIcons name="add" style={{fontSize:40,marginLeft:'40%',color:'grey'}} onPress={onPress}/>
            ...
            <View style={styles.card}>
              <View><Image style={globalStyles.image} source={require('../assets/debitcard.jpg')}/></View>
                <Text style={{fontWeight:'bold',fontSize:24,margin:10, color: color}}>Pay Off Student Loan</Text>
            ...
            <View style={styles.card}>
              <View ><Image style={globalStyles.image} source={require('../assets/safety.jpg')}/></View>
                <Text style={{fontWeight:'bold',fontSize:24,margin:10, color:color}}>Save for retirement</Text>
